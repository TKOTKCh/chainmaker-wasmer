...
//!
//! ```shell
//! cargo run --example wasi-manual-setup --release --features "cranelift"
//! ```
//!
//! Ready?
...
use wasmer::{
    ...
    wat2wasm,TypedFunction,
};
use wasmer_compiler_cranelift::Cranelift;
use wasmer_middlewares::metering::ChainMakerMetering;
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    let wasm_path = concat!(
        ...
        "/tests/wasi-wast/wasi/unstable/testgas-go.wasm"
    );
    ...
    let metering = Arc::new(ChainMakerMetering::new(10, cost_function));
